    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            SizedBox(width: MediaQuery.of(context).size.width, child: SizedBox(height: MediaQuery.of(context).size.height * .25, child: LottieBuilder.asset("assets/lottie/lottie_login.json"))),
            Form(
              key: _formKey,
              child: Padding(
